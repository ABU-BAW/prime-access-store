    ...
    return ( 
        <>
            ...
            <div className="flex justify-between px-8 py-10 ">
                ...
                <div className="h-72 w-72 bg-white border border-black/20 rounded-2xl flex flex-col justify-end items-center pb-12 shadow-md">
                ...
                <div className="h-72 w-72 bg-white border border-black/20 rounded-2xl flex flex-col justify-end items-center pb-12  shadow-md">
                    ...
                    <p className="text-2xl font-bold">1030</p>
                </div>
            ...
            <div className="flex gap-8 px-8 pb-10">
                <div className="bg-white min-h-80 w-3/5  border border-black/20 rounded-2xl"></div>
