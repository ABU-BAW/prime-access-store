        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <img src="/logo.svg" className="h-8 w-auto" alt="Prime Access GH Logo" />
              <span className="text-base font-bold leading-tight">Prime Access GH</span>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 text-foreground/80 text-xs">
              <div className="flex items-start gap-2">
                ...
                <a href="mailto:info@primeaccess.gh" className="hover:text-black transition-colors break-all">
                  info@primeaccess.gh
                </a>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="leading-tight">
                  <p>Kawkudi, Opposite National Mosque</p>
                  <p>Accra, Ghana</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <a href="tel:+233599428820" className="hover:text-black transition-colors">
                  0599428820
                </a>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-background hover:bg-black hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="Facebook"
              >
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1.5 text-foreground/80 text-xs">
              <li>
