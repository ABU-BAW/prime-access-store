          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-foreground/80">
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:info@primeaccess.gh" className="hover:text-black transition-colors">
                  info@primeaccess.gh
                </a>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <a href="tel:+233123456789" className="hover:text-black transition-colors">
                  0599428820
                </a>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-12 h-12 rounded-full bg-background hover:bg-black hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110"
                aria-label="Facebook"
              >
